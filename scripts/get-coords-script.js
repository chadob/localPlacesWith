...
function getCoords(data, loc, i, totalRuns) {
  console.log('ran');
...
function doScaledTimeout(i, amount, object, prop, func, totalRuns) {
  setTimeout(function() {
    func(object, prop, i, totalRuns);
  }, i * amount);
}

function loopOverObject(amount, object, func) {
...
//call the loop
loopOverObject(1000, allData, getCoords);
